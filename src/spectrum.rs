...
impl TabularDistribution {
    ...
    pub const fn new(label: &'static str, start: usize, data: &'static [Float]) -> Self {
        Self { label, start, data }
    }
}
...
impl FixedDistribution {
    ...
    pub const fn new(label: &'static str, start: usize, len: usize, value: Float) -> Self {
        Self {
            label,
            start,
            len,
...
pub const CIE_ILLUMINANT_E: FixedDistribution =
    FixedDistribution::new("Illuminant E", 300, 530, 100.0);
