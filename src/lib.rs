...
//!
//! With `pyffi` enabled, prettypretty includes a fair number of methods
//! manually written methods on existing types and helper types and traits
//! generated by PyO3.
#![cfg_attr(
    feature = "pyffi",
    doc = "When a handwritten constant or function is available only in one
    of the two languages, the documentation clearly labels the items as <i
