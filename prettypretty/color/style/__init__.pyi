...
class Colorant:
    ...
    def sgr_parameters(self, layer: Layer) -> None | bytes: ...
...
class Stylist:
    ...
    def embedded_rgb(self, r: int, g: int, b: int) -> Colorist: ...
    def gray(self, level: int) -> Colorist: ...
    def rgb(self, r: int, g: int, b: int) -> Colorist: ...
    def foreground(
        self,
        color: (
            int | AnsiColor | EmbeddedRgb | GrayGradient | EightBitColor | TrueColor
...
class Colorist:
    """A builder for adding color to styles."""
    def fg(self) -> Stylist: ...
    def on(self) -> Stylist: ...
    def bg(self) -> Stylist: ...
    def __repr__(self) -> str: ...
