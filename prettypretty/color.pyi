...
class Illuminant:
    ...
    def start(self) -> int: ...
    def end(self) -> int: ...
    def __iter__(self) -> IlluminantIter: ...
    def __len__(self) -> int: ...
    def __getitem__(self, index: int) -> float: ...
    def __repr__(self) -> str: ...


class IlluminantIter:
    """An iterator over the data of an illuminant."""
...
class Observer:
    ...
    def start(self) -> int: ...
    def end(self) -> int: ...
    def __iter__(self) -> ObserverIter: ...
    def __len__(self) -> int: ...
...
class ObserverIter:
    """An iterator over the data of an observer."""
    def __iter__(self) -> Self: ...
...
class ColorSpace:
    ...
    def boundaries(self, segment_size: int) -> None | GamutTraversal: ...
    def __hash__(self) -> int: ...
    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
    def __str__(self) -> str: ...
